...
默认基址：`https://advx26.babelbeast.com`
...
```powershell
flutter run -d 53740dd4 --dart-define=CLOUD_MEDIA_BASE=https://advx26.babelbeast.com
```
...
curl -i \
  ...
  https://advx26.babelbeast.com/api/v1/contents
```
